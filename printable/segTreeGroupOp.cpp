//T - data typed, PushT - pushed value type
//opPush - returns pair, what to push to children of this vertex
//opApply - apply pushed value to vertex (this callback should null pushed)
//opPendingCompose - 1 arg - current pushed value, 2arg - value pushed from parent, should return new pushed value for vertex

//RMQ for min with addition
...
//lambda maybe slow (up to +35%), maybe should write ops as class members (which disallow to create 2 different types of RMQ
